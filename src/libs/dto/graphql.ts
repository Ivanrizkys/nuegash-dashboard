...
export type GetOverviewDataQuery = {
  ...
  tasksCollection?: {
    ...
    edges: Array<{
      ...
      node: {
        ...
        image_hash: string;
        slug: string;
        task_categories: { __typename?: "task_categories"; name: string };
      };
    }>;
  } | null;
  mentorsCollection?: {
  ...
  activity?: {
    ...
    edges: Array<{
      __typename?: "task_reportsEdge";
      node: { __typename?: "task_reports"; id: any; name: string; data: any };
    }>;
  } | null;
  runningTask?: {
    __typename?: "task_reportsConnection";
...
export type GetMentorsDataQuery = {
  __typename?: "Query";
  recentMentors?: {
    __typename?: "mentorsConnection";
    edges: Array<{
  ...
  definitions: [
    {
      ...
      operation: "query",
      name: { kind: "Name", value: "getOverviewData" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "tasksCollection" },
            arguments: [
              {
                kind: "Argument",
                      ...
                      },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "task_categories" },
                              selectionSet: {
                                kind: "SelectionSet",
                                selections: [
                                  {
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "mentorsCollection" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "orderBy" },
                      ...
                      },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "total_task" },
                            },
                            {
                              kind: "Field",
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "total_review" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "is_followed" },
                            },
                            {
                              kind: "Field",
          ...
          {
            kind: "Field",
            alias: { kind: "Name", value: "taskToday" },
            name: { kind: "Name", value: "tasksCollection" },
            arguments: [
              {
                kind: "Argument",
                        ...
                        fields: [
                          {
                            ...
                            value: {
                              kind: "StringValue",
                              value: "1643fb20-4a4e-497e-9bd6-4dc7515642fd",
                              block: false,
                            },
                          },
                        ],
          ...
          {
            kind: "Field",
            alias: { kind: "Name", value: "activity" },
            name: { kind: "Name", value: "task_reportsCollection" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "first" },
          ...
          {
            kind: "Field",
            alias: { kind: "Name", value: "runningTask" },
            name: { kind: "Name", value: "task_reportsCollection" },
            arguments: [
              {
                kind: "Argument",
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            alias: { kind: "Name", value: "theLimit" },
            name: { kind: "Name", value: "tasksCollection" },
            arguments: [
              {
                kind: "Argument",
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getMentorsData" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            kind: "Field",
            alias: { kind: "Name", value: "recentMentors" },
            name: { kind: "Name", value: "mentorsCollection" },
            arguments: [
              {
                kind: "Argument",
...
} as unknown as DocumentNode<GetMentorsDataQuery, GetMentorsDataQueryVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getTaskDetail" },
      variableDefinitions: [
        {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            alias: { kind: "Name", value: "taskDetail" },
            name: { kind: "Name", value: "tasksCollection" },
            arguments: [
              {
                kind: "Argument",
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            },
                            {
                              ...
                              name: {
                                kind: "Name",
                                value: "registered_student",
                              },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "total_hour" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "description" },
...
} as unknown as DocumentNode<GetTaskDetailQuery, GetTaskDetailQueryVariables>;
