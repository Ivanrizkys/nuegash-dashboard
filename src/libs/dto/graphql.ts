...
export type Mentors = Node & {
  ...
  nodeId: Scalars['ID']['output'];
  rating: Scalars['BigFloat']['output'];
  role: Scalars['String']['output'];
  total_review: Scalars['Int']['output'];
  total_task: Scalars['Int']['output'];
};
...
export type MentorsFilter = {
  ...
  and?: InputMaybe<Array<MentorsFilter>>;
  ...
  /** Negates a filter */
  not?: InputMaybe<MentorsFilter>;
  /** Returns true if at least one of its inner filters is true, otherwise returns false */
  or?: InputMaybe<Array<MentorsFilter>>;
...
export type Task_CategoriesFilter = {
  /** Returns true only if all its inner filters are true, otherwise returns false */
  and?: InputMaybe<Array<Task_CategoriesFilter>>;
  created_at?: InputMaybe<DatetimeFilter>;
  id?: InputMaybe<UuidFilter>;
  name?: InputMaybe<StringFilter>;
  nodeId?: InputMaybe<IdFilter>;
  /** Negates a filter */
  not?: InputMaybe<Task_CategoriesFilter>;
  /** Returns true if at least one of its inner filters is true, otherwise returns false */
  or?: InputMaybe<Array<Task_CategoriesFilter>>;
};
...
export type Task_ReportsFilter = {
  /** Returns true only if all its inner filters are true, otherwise returns false */
  and?: InputMaybe<Array<Task_ReportsFilter>>;
  created_at?: InputMaybe<DatetimeFilter>;
  id?: InputMaybe<UuidFilter>;
  name?: InputMaybe<StringFilter>;
  nodeId?: InputMaybe<IdFilter>;
  /** Negates a filter */
  not?: InputMaybe<Task_ReportsFilter>;
  /** Returns true if at least one of its inner filters is true, otherwise returns false */
  or?: InputMaybe<Array<Task_ReportsFilter>>;
};
...
export type Tasks = Node & {
  __typename?: 'tasks';
  assessment: Scalars['JSON']['output'];
  cateogry: Scalars['UUID']['output'];
  created_at: Scalars['Datetime']['output'];
  description: Scalars['String']['output'];
  end_at: Scalars['Datetime']['output'];
  id: Scalars['UUID']['output'];
  image: Scalars['String']['output'];
  image_hash: Scalars['String']['output'];
  mentors: Scalars['JSON']['output'];
  /** Globally Unique Record Identifier */
  nodeId: Scalars['ID']['output'];
  progress: Scalars['Int']['output'];
  registered_student: Scalars['Int']['output'];
  slug: Scalars['String']['output'];
  task_categories: Task_Categories;
  title: Scalars['String']['output'];
  total_hour: Scalars['Int']['output'];
...
export type TasksFilter = {
  ...
  id?: InputMaybe<UuidFilter>;
  image?: InputMaybe<StringFilter>;
  image_hash?: InputMaybe<StringFilter>;
  nodeId?: InputMaybe<IdFilter>;
  /** Negates a filter */
...
export type TasksInsertInput = {
  ...
  id?: InputMaybe<Scalars['UUID']['input']>;
  image?: InputMaybe<Scalars['String']['input']>;
  image_hash?: InputMaybe<Scalars['String']['input']>;
...
export type TasksOrderBy = {
  ...
  id?: InputMaybe<OrderByDirection>;
  image?: InputMaybe<OrderByDirection>;
  image_hash?: InputMaybe<OrderByDirection>;
...
export type GetOverviewDataQuery = { __typename?: 'Query', tasksCollection?: { __typename?: 'tasksConnection', edges: Array<{ __typename?: 'tasksEdge', cursor: string, node: { __typename?: 'tasks', id: any, title: string, cateogry: any, mentors: any, image: string, progress: number, end_at: any, image_hash: string, slug: string, task_categories: { __typename?: 'task_categories', name: string } } }> } | null, mentorsCollection?: { __typename?: 'mentorsConnection', edges: Array<{ __typename?: 'mentorsEdge', cursor: string, node: { __typename?: 'mentors', id: any, name: string, role: string, image: string, total_task: number, rating: any, total_review: number, is_followed: boolean, description: string, created_at: any } }> } | null, taskToday?: { __typename?: 'tasksConnection', edges: Array<{ __typename?: 'tasksEdge', cursor: string, node: { __typename?: 'tasks', id: any, title: string, cateogry: any, mentors: any, image: string, progress: number, end_at: any, assessment: any, image_hash: string, slug: string, task_categories: { __typename?: 'task_categories', name: string } } }> } | null, activity?: { __typename?: 'task_reportsConnection', edges: Array<{ __typename?: 'task_reportsEdge', node: { __typename?: 'task_reports', id: any, name: string, data: any } }> } | null, runningTask?: { __typename?: 'task_reportsConnection', edges: Array<{ __typename?: 'task_reportsEdge', node: { __typename?: 'task_reports', id: any, name: string, data: any } }> } | null, performance?: { __typename?: 'task_reportsConnection', edges: Array<{ __typename?: 'task_reportsEdge', node: { __typename?: 'task_reports', id: any, name: string, data: any } }> } | null };

export type GetTaskDataQueryVariables = Exact<{ [key: string]: never; }>;


export type GetTaskDataQuery = { __typename?: 'Query', theLimit?: { __typename?: 'tasksConnection', edges: Array<{ __typename?: 'tasksEdge', cursor: string, node: { __typename?: 'tasks', id: any, title: string, cateogry: any, mentors: any, image: string, progress: number, end_at: any, image_hash: string, slug: string, task_categories: { __typename?: 'task_categories', name: string } } }> } | null, newTask?: { __typename?: 'tasksConnection', edges: Array<{ __typename?: 'tasksEdge', cursor: string, node: { __typename?: 'tasks', id: any, title: string, cateogry: any, mentors: any, image: string, progress: number, end_at: any, image_hash: string, slug: string, task_categories: { __typename?: 'task_categories', name: string } } }> } | null };

export type GetMentorsDataQueryVariables = Exact<{ [key: string]: never; }>;


export type GetMentorsDataQuery = { __typename?: 'Query', recentMentors?: { __typename?: 'mentorsConnection', edges: Array<{ __typename?: 'mentorsEdge', cursor: string, node: { __typename?: 'mentors', id: any, name: string, role: string, image: string, total_task: number, rating: any, total_review: number, is_followed: boolean, description: string, created_at: any } }> } | null, mentors?: { __typename?: 'mentorsConnection', edges: Array<{ __typename?: 'mentorsEdge', cursor: string, node: { __typename?: 'mentors', id: any, name: string, role: string, image: string, total_task: number, rating: any, total_review: number, is_followed: boolean, description: string, created_at: any } }> } | null };
...
export const GetTaskDetailDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getTaskDetail"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"slug"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"taskDetail"},"name":{"kind":"Name","value":"tasksCollection"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"IntValue","value":"1"}},{"kind":"Argument","name":{"kind":"Name","value":"filter"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"slug"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"slug"}}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"edges"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"cursor"}},{"kind":"Field","name":{"kind":"Name","value":"node"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"registered_student"}},{"kind":"Field","name":{"kind":"Name","value":"total_hour"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"video"}},{"kind":"Field","name":{"kind":"Name","value":"assessment"}},{"kind":"Field","name":{"kind":"Name","value":"task_categories"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]}}]}}]}}]} as unknown as DocumentNode<GetTaskDetailQuery, GetTaskDetailQueryVariables>;