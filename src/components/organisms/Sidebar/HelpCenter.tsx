  ...
  return (
    <div className="relative z-10">
      <div className="w-full h-full bg-secondary-500 text-primary-0 hover:bg-primary-500 peer pointer-events-none rounded-default relative overflow-hidden px-4 pb-4 text-center transition-all duration-500">
        ...
        <button className="bg-primary-0 w-full py-3 rounded-default mt-[45px] pointer-events-auto text-secondary-500 hover:text-primary-500 peer text-xs font-semibold relative cursor-pointer z-20 transition-all duration-500">
          Go To Help Center
        </button>
